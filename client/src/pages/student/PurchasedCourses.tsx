      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="relative w-full sm:w-64">
            <input
              type="text"
              className="w-full pl-10 pr-4 py-2 rounded-full border-2 border-teal-300 focus:border-teal-500 focus:ring focus:ring-teal-200 focus:ring-opacity-50 bg-white text-teal-900 placeholder-teal-400"
